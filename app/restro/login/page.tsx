...
export default function RestroLoginPage() {
  ...
  const [status, setStatus] = useState(
    "Create your restaurant account, then sign in to manage your menu."
  );
  ...
  async function submitRegistration(event: FormEvent<HTMLFormElement>): Promise<void> {
    ...
    try {
      ...
      setStatus("Restaurant account created. Sign in with the same email and password.");
    } catch (error) {
  ...
  return (
    <div className="soft-grid-bg flex flex-1">
      <main className="mx-auto flex w-full max-w-6xl flex-1 flex-col gap-6 px-5 pb-12 pt-10 md:px-8">
        <section className="glass-panel p-6 md:p-8">
          ...
          <h1 className="mt-3 text-3xl font-black text-[var(--brand-deep)] md:text-4xl">
            Restaurant Sign In And Business Onboarding
          </h1>
          <p className="mt-3 max-w-3xl text-sm leading-7 text-[#5f3828]">
            Register your restaurant with full business details, tax configuration,
            and contact information. After onboarding, sign in and manage your
            entire menu, stock, variants, and offers.
          </p>
        ...
        <section className="grid gap-5 xl:grid-cols-[420px_1fr]">
          <article className="elevated-card p-5">
            <h2 className="section-title text-[var(--brand-deep)]">Sign In</h2>
            <p className="mt-1 text-sm text-[#6a3f2c]">
              Existing restaurant partners can log in directly.
            </p>
          ...
          <article className="elevated-card p-5">
            <h2 className="section-title text-[var(--brand-deep)]">Create Restaurant</h2>
            <p className="mt-1 text-sm text-[#6a3f2c]">
              Enter full restaurant and tax details to create your restro account.
            </p>
            ...
            <form className="mt-4 space-y-3" onSubmit={submitRegistration}>
              ...
              <button type="submit" className="food-btn w-full" disabled={isRegistering}>
                {isRegistering ? "Creating Account..." : "Create Restaurant Account"}
              </button>
            </form>
          </article>
        </section>
